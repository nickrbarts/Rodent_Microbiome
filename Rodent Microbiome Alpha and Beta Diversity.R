...
##Create phyloseq object and generate NMDS plot##
...
#For MOVO - herbivore - metadata for single species#
...
#tests included for both ANOVA and glm, same results##
...
bcmatrix <- read.delim("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/Microbiome_9-28-21/exported-BC-matrix-MOVO-SILVA-9-28-21/distance-matrix.tsv")
bcadonis <- adonis2(bcmatrix ~ metadata$Protein*metadata$Fiber, method='bray', perm=999, by="terms")
print(bcadonis)
adonis_OmegaSq(bcadonis, partial = TRUE)

#Weighted UniFrac###
wumatrix <-read.delim("~/Desktop/distance-matrix.tsv")
perm_wu <- adonis2(wumatrix ~ Protein*Fiber, data=metadata, perm=999, by="terms")
print(perm_wu)
adonis_OmegaSq(perm_wu, partial=TRUE)
...
bcmatrix <- read.delim("~/Desktop/NB_Mac/Research/KohlLab/Kohl_Lab Projects/Rodent Microbiome/Microbiome_9-28-21/exported-BC-matrix-GRMO-SILVA-9-28-21/distance-matrix.tsv")
bcadonis <- adonis2(bcmatrix ~ metadata1$Fiber*metadata1$Protein, method='bray', perm=999)
print(bcadonis)
adonis_OmegaSq(bcadonis, partial = TRUE)

#Weighted UniFrac###
wumatrix <-read.delim("~/Desktop/RodentMicrobiome2024/core-metrics-results-GRMO-SILVA/exported-weighted_unifrac_distance_matrix/distance-matrix.tsv")
perm_wu <- adonis2(wumatrix ~ Protein*Fiber, data=metadata, perm=999, by="terms")
print(perm_wu)
adonis_OmegaSq(perm_wu, partial=TRUE)
...
wumatrix <-read.delim("~/Desktop/RodentMicrobiome2024/core-metrics-results-WFMO-SILVA/exported-weighted_unifrac_distance_matrix/distance-matrix.tsv")
perm_wu <- adonis2(wumatrix ~ Protein*Fiber, data=metadata, perm=999, by="terms")
print(perm_wu)
adonis_OmegaSq(perm_wu, partial=TRUE)
...
####ITS####
setwd("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21")
...
#MOVO alpha diversity
shannon <-read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-MOVO-only-9-30-21/shannon_vector.qza")
shannon <- shannon$data %>% rownames_to_column("SampleID")
...
faith <- read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-MOVO-only-9-30-21/faith_pd_vector.qza")
faith <- faith$data %>% rownames_to_column("SampleID")
metadata <- metadata %>% left_join(faith)
head(metadata)
metadata$Fiber <- ordered(metadata$Fiber, levels = c("Low", "High"))
...
ASVs <- read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-MOVO-only-9-30-21/observed_features_vector.qza")
ASVs<- ASVs$data %>% rownames_to_column("SampleID")
metadata <- metadata %>% left_join(ASVs)
head(metadata)
metadata$Fiber <- ordered(metadata$Fiber, levels = c("Low", "High"))
...
###weighted unifrac###
wumatrix <-read.delim("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-MOVO-only-9-30-21/exported-weighted_unifrac_distance_matrix/distance-matrix.tsv")
perm_wu <- adonis2(wumatrix ~ Protein*Fiber, data=metadata, perm=999, by="terms")
print(perm_wu)
adonis_OmegaSq(perm_wu, partial=TRUE)
...
#GRMO alpha diversity
shannon <-read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome//ITS_9-30-21/core-metrics-results-GRMO-only-9-30-21/shannon_vector.qza")
shannon <- shannon$data %>% rownames_to_column("SampleID")
...
faith <- read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-GRMO-only-9-30-21/faith_pd_vector.qza")
faith <- faith$data %>% rownames_to_column("SampleID")
metadata <- metadata %>% left_join(faith)
head(metadata)
metadata$Fiber <- ordered(metadata$Fiber, levels = c("Low", "High"))
...
ASVs <- read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-GRMO-only-9-30-21/observed_features_vector.qza")
ASVs<- ASVs$data %>% rownames_to_column("SampleID")
metadata <- metadata %>% left_join(ASVs)
head(metadata)
metadata$Fiber <- ordered(metadata$Fiber, levels = c("Low", "High"))
...
##Weighted Unifrac##
wumatrix <-read.delim("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-GRMO-only-9-30-21/exported-weighted_unifrac_distance_matrix/distance-matrix.tsv")
perm_wu <- adonis2(wumatrix ~ Protein*Fiber, data=metadata, perm=999, by="terms")
print(perm_wu)
adonis_OmegaSq(perm_wu, partial=TRUE)
...
#WFMO alpha diversity
shannon <-read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-WFMO-only-9-30-21/shannon_vector.qza")
shannon <- shannon$data %>% rownames_to_column("SampleID")
...
faith <- read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-WFMO-only-9-30-21/faith_pd_vector.qza")
faith <- faith$data %>% rownames_to_column("SampleID")
metadata <- metadata %>% left_join(faith)
head(metadata)
metadata$Fiber <- ordered(metadata$Fiber, levels = c("Low", "High"))
...
ASVs <- read_qza("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-WFMO-only-9-30-21/observed_features_vector.qza")
ASVs<- ASVs$data %>% rownames_to_column("SampleID")
metadata <- metadata %>% left_join(ASVs)
head(metadata)
metadata$Fiber <- ordered(metadata$Fiber, levels = c("Low", "High"))
...
##Weighted Unifrac##
wumatrix <-read.delim("~/Desktop/NB_Mac/Research/KohlLab/KohlLabProjects/RodentMicrobiome/ITS_9-30-21/core-metrics-results-WFMO-only-9-30-21/exported-weighted_unifrac_distance_matrix/distance-matrix.tsv")
perm_wu <- adonis2(wumatrix ~ Protein*Fiber, data=metadata, perm=999, by="terms")
print(perm_wu)
adonis_OmegaSq(perm_wu, partial=TRUE)
