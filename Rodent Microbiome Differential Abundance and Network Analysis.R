...
table(tax_table(physeq_16S_MOVO)[, "Phylum"], exclude = NULL) #view low abundant or uncharacterized taxa
physeq_16S_MOVO_sub <- subset_taxa(physeq_16S_MOVO, !is.na(Phylum) & !Phylum %in% c("", "uncharacterized")) #remove any with Phyla = NA
...
plyr::ddply(prevdf_MOVO, "Phylum", function(df){cbind(mean(df$Prevalence),sum(df$Prevalence))}) #Shows prevalence of phyla, remove low prevalnence(?)
prevdf1_MOVO = subset(prevdf_MOVO, Phylum %in% get_taxa_unique(physeq_16S_MOVO_sub, "Phylum"))
ggplot(prevdf1_MOVO, aes(TotalAbundance, Prevalence / nsamples(physeq_16S_MOVO_sub),color=Phylum)) +
...
length(get_taxa_unique(ps_16S_MOVO, taxonomic.rank = "Phylum"))
...
table(tax_table(physeq_ITS_MOVO)[, "Phylum"], exclude = NULL) #view low abundant or uncharacterized taxa
physeq_ITS_MOVO_sub <- subset_taxa(physeq_ITS_MOVO, !is.na(Phylum) & !Phylum %in% c("", "uncharacterized")) #remove any with Phyla = NA
# Compute prevalence of each feature, store as data.frame
...
plyr::ddply(prevdf_ITS_MOVO, "Phylum", function(df){cbind(mean(df$Prevalence),sum(df$Prevalence))}) #Shows prevalence of phyla, remove low prevalnence(?)
prevdf1_ITS_MOVO = subset(prevdf_ITS_MOVO, Phylum %in% get_taxa_unique(physeq_ITS_MOVO_sub, "Phylum"))
ggplot(prevdf1_ITS_MOVO, aes(TotalAbundance, Prevalence / nsamples(physeq_ITS_MOVO_sub),color=Phylum)) +
  # Include a guess for parameter
  geom_hline(yintercept = 0.05, alpha = 0.5, linetype = 2) +  geom_point(size = 2, alpha = 0.7) +
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
...
# How many genera would be present after filtering?
length(get_taxa_unique(ps_ITS_MOVO, taxonomic.rank = "Phylum"))
...
ggplot(prevdf1_MOVO, aes(TotalAbundance, Prevalence / nsamples(physeq_16S_MOVO_sub),color=Phylum)) +
  ...
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
prevalenceThreshold = 0.1* nsamples(physeq_16S_MOVO_sub)
prevalenceThreshold
# Execute prevalence filter, using `prune_taxa()` function
keepTaxa = rownames(prevdf1_MOVO)[(prevdf1_MOVO$Prevalence >= prevalenceThreshold)]
ps_16S_MOVO = prune_taxa(keepTaxa, physeq_16S_MOVO_sub)
...
ggplot(prevdf1_ITS_MOVO, aes(TotalAbundance, Prevalence / nsamples(physeq_ITS_MOVO_sub),color=Phylum)) +
  ...
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
prevalenceThreshold = 0.1* nsamples(physeq_ITS_MOVO_sub)
prevalenceThreshold
# Execute prevalence filter, using `prune_taxa()` function
keepTaxa = rownames(prevdf1_ITS_MOVO)[(prevdf1_ITS_MOVO$Prevalence >= prevalenceThreshold)]
ps_ITS_MOVO = prune_taxa(keepTaxa, physeq_ITS_MOVO_sub)
...
table(tax_table(physeq_16S_WFMO)[, "Phylum"], exclude = NULL) #view low abundant or uncharacterized taxa
physeq_16S_WFMO_sub <- subset_taxa(physeq_16S_WFMO, !is.na(Phylum) & !Phylum %in% c("", "uncharacterized")) #remove any with Phyla = NA
# Compute prevalence of each feature, store as data.frame
...
plyr::ddply(prevdf_WFMO, "Phylum", function(df){cbind(mean(df$Prevalence),sum(df$Prevalence))}) #Shows prevalence of phyla, remove low prevalnence(?)
prevdf1_WFMO = subset(prevdf_WFMO, Phylum %in% get_taxa_unique(physeq_16S_WFMO_sub, "Phylum"))
ggplot(prevdf1_WFMO, aes(TotalAbundance, Prevalence / nsamples(physeq_16S_WFMO_sub),color=Phylum)) +
  # Include a guess for parameter
  geom_hline(yintercept = 0.05, alpha = 0.5, linetype = 2) +  geom_point(size = 2, alpha = 0.7) +
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
...
# How many genera would be present after filtering?
length(get_taxa_unique(ps_16S_WFMO, taxonomic.rank = "Phylum"))
...
table(tax_table(physeq_ITS_WFMO)[, "Phylum"], exclude = NULL) #view low abundant or uncharacterized taxa
physeq_ITS_WFMO_sub <- subset_taxa(physeq_ITS_WFMO, !is.na(Phylum) & !Phylum %in% c("", "uncharacterized")) #remove any with Phyla = NA
# Compute prevalence of each feature, store as data.frame
...
plyr::ddply(prevdf_ITS_WFMO, "Phylum", function(df){cbind(mean(df$Prevalence),sum(df$Prevalence))}) #Shows prevalence of phyla, remove low prevalnence(?)
prevdf1_ITS_WFMO = subset(prevdf_ITS_WFMO, Phylum %in% get_taxa_unique(physeq_ITS_WFMO_sub, "Phylum"))
ggplot(prevdf1_ITS_WFMO, aes(TotalAbundance, Prevalence / nsamples(physeq_ITS_WFMO_sub),color=Phylum)) +
  # Include a guess for parameter
  geom_hline(yintercept = 0.05, alpha = 0.5, linetype = 2) +  geom_point(size = 2, alpha = 0.7) +
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
...
# How many genera would be present after filtering?
length(get_taxa_unique(ps_ITS_WFMO, taxonomic.rank = "Phylum"))
...
table(tax_table(physeq_16S_GRMO)[, "Phylum"], exclude = NULL) #view low abundant or uncharacterized taxa
physeq_16S_GRMO_sub <- subset_taxa(physeq_16S_GRMO, !is.na(Phylum) & !Phylum %in% c("", "uncharacterized")) #remove any with Phyla = NA
# Compute prevalence of each feature, store as data.frame
...
plyr::ddply(prevdf_GRMO, "Phylum", function(df){cbind(mean(df$Prevalence),sum(df$Prevalence))}) #Shows prevalence of phyla, remove low prevalnence(?)
prevdf1_GRMO = subset(prevdf_GRMO, Phylum %in% get_taxa_unique(physeq_16S_GRMO_sub, "Phylum"))
ggplot(prevdf1_GRMO, aes(TotalAbundance, Prevalence / nsamples(physeq_16S_GRMO_sub),color=Phylum)) +
  # Include a guess for parameter
  geom_hline(yintercept = 0.05, alpha = 0.5, linetype = 2) +  geom_point(size = 2, alpha = 0.7) +
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
...
# How many genera would be present after filtering?
length(get_taxa_unique(ps_16S_GRMO, taxonomic.rank = "Phylum"))
...
table(tax_table(physeq_ITS_GRMO)[, "Phylum"], exclude = NULL) #view low abundant or uncharacterized taxa
physeq_ITS_GRMO_sub <- subset_taxa(physeq_ITS_GRMO, !is.na(Phylum) & !Phylum %in% c("", "uncharacterized")) #remove any with Phyla = NA
# Compute prevalence of each feature, store as data.frame
...
plyr::ddply(prevdf_ITS_GRMO, "Phylum", function(df){cbind(mean(df$Prevalence),sum(df$Prevalence))}) #Shows prevalence of phyla, remove low prevalnence(?)
prevdf1_ITS_GRMO = subset(prevdf_ITS_GRMO, Phylum %in% get_taxa_unique(physeq_ITS_GRMO_sub, "Phylum"))
ggplot(prevdf1_ITS_GRMO, aes(TotalAbundance, Prevalence / nsamples(physeq_ITS_GRMO_sub),color=Phylum)) +
  # Include a guess for parameter
  geom_hline(yintercept = 0.05, alpha = 0.5, linetype = 2) +  geom_point(size = 2, alpha = 0.7) +
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
...
# How many genera would be present after filtering?
length(get_taxa_unique(ps_ITS_GRMO, taxonomic.rank = "Phylum"))
...
ggplot(prevdf1_GRMO, aes(TotalAbundance, Prevalence / nsamples(physeq_16S_GRMO_sub),color=Phylum)) +
  ...
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
prevalenceThreshold = 0.1* nsamples(physeq_16S_GRMO_sub)
prevalenceThreshold
# Execute prevalence filter, using `prune_taxa()` function
keepTaxa = rownames(prevdf1_GRMO)[(prevdf1_GRMO$Prevalence >= prevalenceThreshold)]
ps_16S_GRMO = prune_taxa(keepTaxa, physeq_16S_GRMO_sub)
...
ggplot(prevdf1_ITS_GRMO, aes(TotalAbundance, Prevalence / nsamples(physeq_ITS_GRMO_sub),color=Phylum)) +
  ...
  scale_x_log10() +  xlab("Total Abundance") + ylab("Prevalence [Frac. Samples]") +
  facet_wrap(~Phylum) + theme(legend.position="none")
prevalenceThreshold = 0.1* nsamples(physeq_ITS_GRMO_sub)
prevalenceThreshold
# Execute prevalence filter, using `prune_taxa()` function
keepTaxa = rownames(prevdf1_ITS_GRMO)[(prevdf1_ITS_GRMO$Prevalence >= prevalenceThreshold)]
ps_ITS_GRMO = prune_taxa(keepTaxa, physeq_ITS_GRMO_sub)
